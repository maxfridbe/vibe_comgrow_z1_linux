...
pub fn generate_image_gcode(path: &str, pwr_max: f32, speed: f32, scale: f32, passes: u32, fit: Option<(f32, f32)>, center: (f32, f32), low_fid: f32, high_fid: f32) -> Result<(String, String), Box<dyn std::error::Error + Send + Sync>> {
